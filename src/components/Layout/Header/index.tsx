...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-40 w-full pb-5 transition-all duration-300 border-b border-gray-300 bg-white ${sticky ? " shadow-lg py-5" : "shadow-none py-6"
        }`}
    >
      <div className="lg:py-0 py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="#"
              className="hidden lg:block bg-primary text-white hover:bg-primary/15 hover:text-primary px-10 py-2 rounded-full text-lg font-medium"
              onClick={() => {
            ...
            <Link
              href="#"
              className="hidden lg:block bg-primary/15 hover:bg-primary text-primary hover:text-white px-10 py-2 rounded-full text-lg font-medium"
              onClick={() => {
